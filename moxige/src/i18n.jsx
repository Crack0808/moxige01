...
const translations = {
  es: {
    appLang: "Español (México)",
    switchTo: "Switch to English",
    loginTitle: "Bienvenido",
    phone: "Teléfono",
    email: "Correo",
    password: "Contraseña",
    placeholderPhone: "Introduzca un número de 10 dígitos",
    placeholderEmail: "Introduzca su correo",
    placeholderPassword: "Introduzca la contraseña",
    submitLogin: "Iniciar sesión",
    registerLink: "¿No tienes cuenta? Regístrate",
    errorPhone: "Ingrese un número de 10 dígitos",
    ...
    filterAssign: "Asignación",
    assignAll: "Todos",
    assignAssigned: "Asignado",
    assignUnassigned: "Sin asignación",
    ...
    noAccessDesc: "Solo personal puede acceder a esta página.",
    ...
    viewTopGainers: "Más ganadores",
    viewTopLosers: "Más perdedores", 
    ...
    errorAmountInvalid: "Ingrese un importe válido",
    ...
    price: "Precio",
    placeholderLimitPrice: "Ingrese precio límite",
    status: "Estado",
    filled: "Completada",
    waitingFill: "Esperando",
    limitTooHigh: "El precio límite no puede ser mayor que el precio actual",
    limitTooLow: "El precio límite no puede ser menor que el precio actual",
    bottomNote: "(Esta es la navegación inferior)",
    ...
    klineSettings: "Configuración",
    // Settings page labels
    nameLabel: "Nombre",
    phoneLabel: "Teléfono",
    loginPwdLabel: "Contraseña de inicio de sesión",
    tradePwdLabel: "PIN de transacción",
    kycTitle: "Verificación",
    ...
    institutionDesc: "Administre cuentas de empresa: KYC, límites, permisos y contactos.",
    institutionOrgName: "Nombre de la empresa",
    institutionOrgIntro: "Descripción de la empresa",
    institutionFundsTitle: "Fondos de cuenta",
    institutionEntriesTitle: "Accesos rápidos",
    ...
    institutionKycPending: "Pendiente de verificación",
    ...
    institutionTabHoldings: "Posición actual",
    ...
    confirm: "Confirmar",
    saving: "Guardando...",
    changeTradePinTitle: "Cambiar PIN de transacción",
    verifyWithLoginPassword: "Ingrese contraseña para verificar",
    ...
    errorNameSaveFailed: "Error al guardar el nombre, inténtelo de nuevo",
    errorOldPasswordWrong: "Contraseña actual incorrecta",
    errorNewPasswordLength: "La nueva contraseña debe tener al menos 6 caracteres",
    successLoginPasswordUpdated: "Contraseña actualizada",
    errorLoginPasswordUpdate: "Error al actualizar la contraseña",
    errorLoginVerifyFailed: "Falló la verificación de contraseña",
    errorTradePinLength: "El PIN debe tener 6 dígitos",
    successTradePinUpdated: "PIN de transacción actualizado",
    errorTradePinUpdate: "Error al actualizar el PIN",
    // Settings modal hints
    hintLoginPwdModal: "La nueva contraseña debe tener al menos 6 caracteres.",
    hintTradePinModal: "PIN de 6 dígitos, verifique con contraseña de inicio de sesión.",

    // Bank cards
    bankCardsTitle: "Tarjetas bancarias vinculadas",
    bankCardsDesc: "Administre sus tarjetas solo para retiros.",
    bankCardsHint: "Solo para retiros; no se puede pagar en línea.",
    addBankCard: "Agregar tarjeta",
    cardNumber: "Número de tarjeta/CLABE",
    holderName: "Nombre del titular",
    bankName: "Banco",
    placeholderCardNumber: "Ingrese número de tarjeta/CLABE",
    placeholderHolderName: "Ingrese el nombre del titular aquí",
    placeholderBankName: "Ingrese el nombre del banco aquí",
    hintBankNameInput: "",
    addCardHint: "Ingrese número de tarjeta/CLABE (15, 16 o 18 dígitos).",
    errorCardNumber: "Número inválido (México: 15, 16 o 18 dígitos)",
    errorHolderName: "Nombre del titular inválido",
    errorBankName: "Seleccione un banco",
    successCardAdded: "Tarjeta agregada",
    edit: "Editar",
    delete: "Eliminar",
    confirmDeleteTitle: "Confirmar eliminación",
    confirmDeleteDesc: "¿Desea eliminar esta tarjeta?",
    confirmYes: "Sí",
    confirmNo: "No",
    ...
    // Wallet addresses
    walletsTitle: "Dirección de billetera",
    walletsDesc: "Vincule su dirección de criptomonedas para retiros",
    walletAddressLabel: "Dirección",
    walletsListTitle: "Direcciones guardadas",
    // Wallet relaxed validation prompts
    errorInvalidAddress: "Dirección inválida (debe estar llena)",
    editAddressPrompt: "Editar dirección",
    ...
    btnRetry: "Reintentar",
    btnClearCacheReload: "Borrar caché y recargar",
    chartInitializing: "Inicializando gráfico...",
    chartUnavailableTitle: "Datos del gráfico no disponibles",
    chartUnavailableMessage: "El símbolo o los datos del gráfico no están disponibles temporalmente.",
    btnTryYahoo: "Probar Yahoo Finance",
    fallbackReasonYahooMexico: "📊 Usando datos de Yahoo Finance (fuente dedicada a México)",
    fallbackReasonYahooUnavailable: "📊 Usando datos de Yahoo Finance (TradingView no disponible)",
    fallbackReasonNativeFallback: "📊 Usando gráfico nativo (regresó de TradingView)",
    ...
    instIntro: "Este bloque muestra la presentación de la empresa",
    instOrgNameDefault: "Nombre de la empresa",
    instOrgDescDefault: "Descripción de la empresa",
    instFunds: "Fondos",
    instBlocks: "Operaciones grandes",
    instIpoRwa: "IPO/RWA",
    instPositionsCurrent: "Posición actual",
    instPositionsDone: "Completado",
    instPositionsEmpty: "Sin datos aún",
    // Locking
    locked: "Bloqueado",
    lock: "Bloquear",
    unlock: "Desbloquear",
    ...
    // Invite code modal
    inviteTitle: "Ingrese su código de invitación institucional",
    invitePlaceholder: "Ingrese su código de invitación",
    ...
    withdrawRecordsLink: "Historial de retiros",
    currencyLabel: "Moneda",
    bankCardLabel: "Tarjeta bancaria",
    usdtAddressLabel: "Dirección USDT",
    networkLabel: "Red",
    amountLabel: "Importe",
    btnSubmitWithdraw: "Enviar retiro",
  ...
  en: {
    ...
    fallbackReasonYahooMexico: "📊 Using Yahoo Finance data (Mexico stocks dedicated source)",
